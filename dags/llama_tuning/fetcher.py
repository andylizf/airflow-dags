...
def fetch_github_issues(owner: str, repo: str, token: str) -> List[Issue]:
    ...
    while True:
        ...
        for issue in page_issues:
            ...
            comments = [c["body"] for c in comments_response.json()] if comments_response.status_code == 200 else []
...
def fetch_github_discussions(owner: str, repo: str, token: str) -> List[Dict[str, Any]]:
...
Based on these criteria, is this a feature request requiring implementation? """ + SPLITTER
    ...
    return filtered_items, {
        ...
        "statistics": {
            ...
            "feature_requests_from_issues": sum(1 for r in classification_results 
                if r.get("source") == "issue" and r.get("accepted")),
            "feature_requests_from_discussions": sum(1 for r in classification_results 
